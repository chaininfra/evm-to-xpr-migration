...
class Allowance extends Table {
     ...
     */
    constructor(public spender: Name = new Name(), public amount: Asset = new Asset()) { super(); }
...
export class erc20like extends Contract {
     ...
     * contract.mint(Name.fromString("alice"), Asset.fromString("1000.0000 CINFRA"));
     * ```
     */
    @action("mint")
     ...
     *   Name.fromString("alice"),    // spender
     *   Name.fromString("bob"),      // from (owner)
     *   Name.fromString("charlie"),  // to
     *   Asset.fromString("100.0000 CINFRA"), 
     *   "delegated payment"
     * );
     * ```
     ...
     * contract.balanceOf(Name.fromString("alice"));
     ...
     * contract.allowance(Name.fromString("bob"), Name.fromString("alice"));
